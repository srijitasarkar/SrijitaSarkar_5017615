...
class TaskLinkedList {
    ...
    public static void main(String[] args) {
        ...
        // Adding tasks
        taskList.addTask(new Task(1, "Do the homework", "Pending"));
        taskList.addTask(new Task(2, "Do the chores", "In Progress"));
        taskList.addTask(new Task(3, "Complete the book", "Completed"));
